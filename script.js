// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$67,309', change:'+1.0%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,046', change:'+2.1%', up:true, icon:'assets/logos/eth.svg' },
  ...
  { type:'price', symbol:'BNB', price:'$615.59', change:'+0.3%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0927', change:'+1.6%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.66', change:'+1.7%', up:true, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$8.82', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0913', change:'+1.6%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000601', change:'+3.4%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.46', change:'+2.1%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.20', change:'+2.1%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000338', change:'+2.2%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$335.65', change:'+2.9%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$227.04', change:'+4.3%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.148', change:'+2.9%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00660', change:'+3.2%', up:true, icon:'assets/logos/pengu.png' },
