// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$74,595', change:'-3.4%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,026', change:'-4.4%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$81.93', change:'-5.9%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$639.12', change:'-2.6%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.31', change:'-3.3%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.238', change:'-5.3%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0994', change:'-5.9%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.17', change:'-6.6%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.999', change:'-9.5%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$8.85', change:'-7.0%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.78', change:'-10.9%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.21', change:'-8.3%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.105', change:'-6.7%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000551', change:'-5.5%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.32', change:'-7.4%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$2.08', change:'-8.4%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000348', change:'-8.1%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.03', change:'-5.1%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$377.15', change:'-2.0%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$597.01', change:'-7.0%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.191', change:'-12.4%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00856', change:'-10.7%', up:false, icon:'assets/logos/pengu.png' },
