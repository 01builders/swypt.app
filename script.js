// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$67,458', change:'+1.4%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,055', change:'+2.9%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$84.14', change:'+2.2%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$617.44', change:'+0.8%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0927', change:'+1.9%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.76', change:'+2.9%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.878', change:'+2.0%', up:true, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.092', change:'+2.7%', up:true, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'UNI', price:'$3.51', change:'+3.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.20', change:'+3.4%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000335', change:'+1.6%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.68', change:'+1.6%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$334.54', change:'+2.0%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$226.13', change:'+4.4%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.15', change:'+4.5%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00650', change:'+2.1%', up:true, icon:'assets/logos/pengu.png' },
