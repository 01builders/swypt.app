// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$68,626', change:'-2.8%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,081', change:'-3.3%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$87.31', change:'-2.9%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$629.41', change:'-2.1%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.39', change:'-3.6%', up:false, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.091', change:'-3.1%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.77', change:'-3.6%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$9.11', change:'-4.2%', up:false, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.31', change:'+0.0%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.0938', change:'-5.6%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000576', change:'-4.0%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.46', change:'-3.6%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.28', change:'-2.3%', up:false, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.77', change:'-4.2%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$345.63', change:'-0.9%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$217.07', change:'-7.0%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.151', change:'-5.2%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00675', change:'-4.5%', up:false, icon:'assets/logos/pengu.png' },
