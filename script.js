// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$79,057', change:'-2.5%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,217', change:'-3.2%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$88.81', change:'-4.0%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$670.44', change:'-1.4%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.43', change:'-2.5%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.258', change:'-4.5%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.111', change:'-2.8%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$10.00', change:'-5.4%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.09', change:'-10.3%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.47', change:'-5.3%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.98', change:'-7.1%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.31', change:'-4.6%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.351', change:'-0.9%', up:false, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.123', change:'-7.5%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000610', change:'-3.9%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.59', change:'-3.9%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.52', change:'-5.5%', up:false, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.94', change:'-5.7%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$386.01', change:'-3.5%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$513.97', change:'-6.1%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.21', change:'-7.6%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00871', change:'-5.4%', up:false, icon:'assets/logos/pengu.png' },
