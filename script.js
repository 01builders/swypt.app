// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$62,846', change:'-0.8%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,878', change:'-0.4%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$75.17', change:'-1.3%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$606.43', change:'-0.7%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$0.998', change:'-1.0%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.179', change:'-1.6%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0697', change:'-0.6%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.95', change:'+1.3%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.677', change:'-1.4%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$6.41', change:'+0.0%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.33', change:'-0.4%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.756', change:'-2.2%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.332', change:'-0.5%', up:false, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.0738', change:'-1.9%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000457', change:'+3.1%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.20', change:'-8.0%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.62', change:'-0.6%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000264', change:'-1.2%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.49', change:'-1.6%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$394.69', change:'-0.5%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$490.77', change:'+1.0%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.168', change:'-0.9%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00606', change:'-2.7%', up:false, icon:'assets/logos/pengu.png' },
