// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$78,370', change:'-0.2%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,309', change:'-0.0%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$84.09', change:'-0.2%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$618.44', change:'-0.3%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.39', change:'-0.3%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.25', change:'+0.0%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'SUI', price:'$0.923', change:'-0.2%', up:false, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'DOT', price:'$1.21', change:'-0.2%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.332', change:'+1.8%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.122', change:'-2.2%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000626', change:'-1.3%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.24', change:'-0.2%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.29', change:'+0.4%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000396', change:'-0.5%', up:false, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$383.24', change:'+2.1%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$379.05', change:'-2.1%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.18', change:'-0.0%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00992', change:'-1.1%', up:false, icon:'assets/logos/pengu.png' },
