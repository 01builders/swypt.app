// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$66,581', change:'+0.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,008', change:'+0.4%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$82.53', change:'+0.4%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$612.72', change:'+0.2%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0915', change:'+0.6%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.52', change:'+0.6%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.86', change:'-0.2%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$8.70', change:'-0.6%', up:false, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.321', change:'+1.5%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.09', change:'+0.0%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000589', change:'+1.1%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.40', change:'+0.4%', up:true, icon:'assets/logos/uni.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$329.80', change:'+0.6%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$217.64', change:'+1.7%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.145', change:'+0.6%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00639', change:'+0.1%', up:true, icon:'assets/logos/pengu.png' },
