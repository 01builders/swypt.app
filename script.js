// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$73,593', change:'-0.9%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,009', change:'-0.5%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$82.09', change:'-0.1%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$638.53', change:'-1.3%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.32', change:'+0.9%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.235', change:'-0.6%', up:false, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.00', change:'-1.2%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.931', change:'-2.7%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$8.92', change:'-1.0%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.77', change:'-3.1%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.21', change:'-0.8%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.352', change:'-4.3%', up:false, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.104', change:'-2.3%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000536', change:'-1.2%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.05', change:'-1.4%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$2.43', change:'-2.4%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000338', change:'-2.1%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.06', change:'-2.9%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$355.71', change:'-9.3%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$548.72', change:'+1.2%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.176', change:'-6.6%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00775', change:'-4.5%', up:false, icon:'assets/logos/pengu.png' },
