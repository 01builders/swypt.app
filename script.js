// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$70,940', change:'-2.7%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,188', change:'-2.7%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$81.72', change:'-3.6%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$592.49', change:'-2.4%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.33', change:'-1.7%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.238', change:'-4.3%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0907', change:'-2.4%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.72', change:'-3.5%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.902', change:'-4.1%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$8.98', change:'-4.1%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.46', change:'+4.8%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.23', change:'-4.2%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.323', change:'+1.2%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.111', change:'-4.1%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000577', change:'-3.0%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.02', change:'-4.0%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.34', change:'-2.8%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000347', change:'-4.1%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.72', change:'-2.7%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$338.83', change:'+0.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$362.41', change:'-4.1%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00648', change:'-4.6%', up:false, icon:'assets/logos/pengu.png' },
