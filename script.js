// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$67,902', change:'+1.4%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,073', change:'+2.2%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.74', change:'+0.8%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$614.23', change:'-0.1%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.33', change:'-0.8%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.247', change:'+1.2%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$8.77', change:'+2.0%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.878', change:'+1.2%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.01', change:'+2.6%', up:true, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0927', change:'+2.0%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000595', change:'+0.8%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.55', change:'+3.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.18', change:'-0.4%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000337', change:'+1.0%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.69', change:'+1.6%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$327.07', change:'-1.0%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$231.10', change:'+4.7%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.155', change:'+6.1%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00651', change:'+1.1%', up:true, icon:'assets/logos/pengu.png' },
