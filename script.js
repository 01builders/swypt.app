// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,230', change:'-0.2%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,913', change:'-0.0%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$73.70', change:'-0.2%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$577.95', change:'+1.3%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.08', change:'-0.8%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.164', change:'-0.0%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.07', change:'-1.0%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.32', change:'-1.1%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.42', change:'+0.6%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.768', change:'+0.8%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'SHIB', price:'$0.00000460', change:'-0.4%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$4.02', change:'+3.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.63', change:'+2.2%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000274', change:'+0.0%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.29', change:'-0.0%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$355.66', change:'+2.1%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$475.71', change:'+3.2%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.196', change:'+1.2%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00580', change:'-1.0%', up:false, icon:'assets/logos/pengu.png' },
