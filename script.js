// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,355', change:'+0.7%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,906', change:'+0.3%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$74.03', change:'+0.8%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$589.83', change:'+3.3%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.08', change:'+0.8%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.169', change:'+4.4%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'DOT', price:'$0.767', change:'+0.7%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0774', change:'-1.9%', up:false, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'UNI', price:'$4.50', change:'+12.9%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.65', change:'+1.8%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.23', change:'-3.3%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$354.95', change:'+0.7%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$461.37', change:'-2.1%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00603', change:'+4.1%', up:true, icon:'assets/logos/pengu.png' },
