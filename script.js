// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$67,345', change:'+0.5%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,055', change:'+0.0%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$80.81', change:'+0.4%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$591.09', change:'+0.4%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.31', change:'-0.8%', up:false, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$8.67', change:'-0.5%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$8.94', change:'-1.9%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.23', change:'-0.8%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.25', change:'+0.0%', up:true, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.317', change:'+0.9%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.0924', change:'-0.6%', up:false, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.26', change:'+4.3%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.71', change:'-0.2%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$317.77', change:'-0.0%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$247.40', change:'+5.2%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00624', change:'-2.2%', up:false, icon:'assets/logos/pengu.png' },
