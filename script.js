// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$73,314', change:'-0.9%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,993', change:'-1.6%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$81.74', change:'-1.4%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$696.03', change:'-5.6%', up:false, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.05', change:'-1.7%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.886', change:'-3.0%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$8.89', change:'-1.5%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.95', change:'+4.7%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.18', change:'-0.8%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.352', change:'+1.5%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.102', change:'-2.1%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000548', change:'-0.7%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.00', change:'-2.0%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$2.33', change:'+1.0%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000339', change:'-1.7%', up:false, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$358.70', change:'-3.5%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$560.90', change:'+2.6%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.192', change:'+3.5%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00774', change:'-3.5%', up:false, icon:'assets/logos/pengu.png' },
