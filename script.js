// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$78,340', change:'+2.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,298', change:'+1.5%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.90', change:'+0.6%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$616.07', change:'-0.1%', up:false, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.12', change:'-0.0%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.92', change:'+1.2%', up:true, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.124', change:'+0.1%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000628', change:'+0.1%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'PEPE', price:'$0.00000394', change:'+0.6%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$381.54', change:'+0.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$382.05', change:'+10.8%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.18', change:'-1.1%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00994', change:'-0.9%', up:false, icon:'assets/logos/pengu.png' },
