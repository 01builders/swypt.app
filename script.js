// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,231', change:'+1.5%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,322', change:'+0.5%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$85.65', change:'+0.8%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$635.87', change:'+1.5%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0953', change:'+0.8%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.40', change:'+1.7%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.956', change:'+1.5%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.37', change:'+1.5%', up:true, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'SHIB', price:'$0.00000609', change:'+1.3%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.38', change:'+2.1%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$363.45', change:'+2.7%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$317.93', change:'+2.4%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.17', change:'-0.4%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00774', change:'+6.7%', up:true, icon:'assets/logos/pengu.png' },
