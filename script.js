// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$74,815', change:'+0.4%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,361', change:'+1.2%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$84.99', change:'+1.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$622.68', change:'+1.0%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.40', change:'+2.4%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.246', change:'+2.1%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.26', change:'+2.2%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.959', change:'+2.3%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.40', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.41', change:'+1.2%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.18', change:'+0.4%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.116', change:'+4.3%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000598', change:'+2.2%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.22', change:'+2.2%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.41', change:'+3.4%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000374', change:'+4.0%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$341.83', change:'-1.1%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$345.58', change:'-4.1%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00717', change:'+4.1%', up:true, icon:'assets/logos/pengu.png' },
