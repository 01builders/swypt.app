// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$77,933', change:'-1.5%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,177', change:'-2.3%', up:false, icon:'assets/logos/eth.svg' },
  ...
  { type:'price', symbol:'BNB', price:'$652.38', change:'-2.2%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.41', change:'-2.0%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.254', change:'-3.0%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.109', change:'-3.3%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.67', change:'-4.1%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.05', change:'-3.9%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.25', change:'-3.1%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.89', change:'-4.4%', up:false, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.119', change:'-4.6%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000579', change:'-5.5%', up:false, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'PEPE', price:'$0.00000374', change:'-3.9%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.03', change:'+4.8%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$387.31', change:'+1.5%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$503.11', change:'-1.4%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.198', change:'-6.4%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00838', change:'-5.0%', up:false, icon:'assets/logos/pengu.png' },
