// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,807', change:'+2.1%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,122', change:'+3.2%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$86.23', change:'+2.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$655.67', change:'+1.2%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.36', change:'+2.2%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.246', change:'+1.8%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.103', change:'+2.1%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.57', change:'+2.9%', up:true, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.79', change:'-1.0%', up:false, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.362', change:'+0.2%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.109', change:'+1.5%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000564', change:'+0.3%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$2.41', change:'+16.9%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$2.10', change:'+1.4%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$386.28', change:'+3.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$630.49', change:'+7.0%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.209', change:'+5.4%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00911', change:'+4.7%', up:true, icon:'assets/logos/pengu.png' },
