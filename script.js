// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$71,859', change:'+0.7%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,205', change:'-0.4%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.82', change:'+0.6%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$606.30', change:'+0.3%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.35', change:'-0.1%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.254', change:'+0.3%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0931', change:'-0.5%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.94', change:'-0.9%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.931', change:'+0.3%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.28', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.29', change:'+2.5%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.103', change:'+2.2%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000597', change:'-0.5%', up:false, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.35', change:'+0.2%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$344.19', change:'+3.4%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$337.32', change:'+1.9%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00658', change:'-0.6%', up:false, icon:'assets/logos/pengu.png' },
