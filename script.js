// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$62,992', change:'-1.7%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,790', change:'-0.9%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$75.98', change:'-1.1%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$568.10', change:'-1.1%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.07', change:'-2.0%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.159', change:'-3.8%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0723', change:'-1.2%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$7.93', change:'-0.5%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.726', change:'-0.0%', up:false, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.61', change:'-2.6%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.83', change:'-2.8%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.091', change:'-6.9%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000419', change:'-2.4%', up:false, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.88', change:'+0.1%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000274', change:'+0.7%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$325.98', change:'-0.2%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$521.66', change:'+1.7%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.199', change:'-0.6%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00592', change:'-2.5%', up:false, icon:'assets/logos/pengu.png' },
