// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$63,660', change:'+0.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,864', change:'-1.1%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$73.69', change:'-0.1%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$589.41', change:'+0.1%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.08', change:'-0.3%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.194', change:'+2.5%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0703', change:'-0.5%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.21', change:'-1.8%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.693', change:'+0.2%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$6.56', change:'-0.8%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.42', change:'-0.4%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.821', change:'+3.0%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0826', change:'+1.6%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000501', change:'+1.9%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.93', change:'-6.8%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.74', change:'+2.0%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000293', change:'+1.0%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.37', change:'+8.4%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$363.07', change:'-0.4%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$483.81', change:'-1.4%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00618', change:'-1.0%', up:false, icon:'assets/logos/pengu.png' },
