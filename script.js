// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$63,621', change:'-0.7%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,779', change:'-1.3%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$81.02', change:'-1.4%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$578.54', change:'-1.4%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.12', change:'-2.4%', up:false, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0746', change:'-3.0%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$7.88', change:'-2.1%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.731', change:'-2.8%', up:false, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.63', change:'-9.3%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.854', change:'-3.8%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.332', change:'+0.7%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.0771', change:'-4.1%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000440', change:'+0.1%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.22', change:'+1.0%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.99', change:'-3.5%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000268', change:'-2.0%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.57', change:'-1.9%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$334.33', change:'+3.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$487.50', change:'+6.9%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.238', change:'+0.2%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00650', change:'-4.6%', up:false, icon:'assets/logos/pengu.png' },
