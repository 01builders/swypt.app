// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$65,023', change:'+0.1%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,917', change:'-0.1%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$76.83', change:'+0.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$604.34', change:'+0.1%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.03', change:'-0.3%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.196', change:'-0.6%', up:false, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$6.53', change:'+0.9%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.33', change:'-0.6%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.808', change:'+0.2%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0799', change:'+3.1%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000469', change:'+1.6%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.66', change:'+2.7%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000288', change:'+0.6%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$395.62', change:'+4.2%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$507.87', change:'-2.8%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00673', change:'+6.6%', up:true, icon:'assets/logos/pengu.png' },
