// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,544', change:'+1.8%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,329', change:'+0.9%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$85.96', change:'+1.1%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$638.55', change:'+1.8%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0956', change:'+1.0%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.45', change:'+2.0%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.957', change:'+1.5%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.40', change:'+1.9%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.38', change:'+5.9%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.39', change:'+2.5%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000382', change:'+1.3%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$366.95', change:'+3.7%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$320.99', change:'+3.5%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00780', change:'+6.7%', up:true, icon:'assets/logos/pengu.png' },
