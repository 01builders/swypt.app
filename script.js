// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$80,845', change:'+0.8%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,330', change:'+0.9%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$93.37', change:'+1.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$651.81', change:'+0.6%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.42', change:'+0.5%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.272', change:'+0.2%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$10.42', change:'+0.9%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.07', change:'+5.2%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.97', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$2.44', change:'-3.2%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.35', change:'-2.3%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.143', change:'-1.3%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000641', change:'-0.7%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.74', change:'+1.7%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.56', change:'-1.9%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000427', change:'-1.0%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.94', change:'+0.3%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$412.08', change:'+3.9%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$596.48', change:'+1.5%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.249', change:'+1.5%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.0108', change:'+3.4%', up:true, icon:'assets/logos/pengu.png' },
