// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$70,943', change:'-1.2%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,178', change:'-3.2%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$82.08', change:'-3.0%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$599.53', change:'-2.5%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.33', change:'-3.6%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.25', change:'-4.6%', up:false, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'SUI', price:'$0.91', change:'-4.3%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.04', change:'-4.1%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.24', change:'-2.4%', up:false, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.102', change:'-1.0%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000588', change:'-4.1%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.08', change:'-4.5%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.34', change:'+0.3%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000348', change:'-5.7%', up:false, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$326.60', change:'-3.7%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$318.38', change:'-1.2%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.16', change:'-5.1%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00633', change:'-7.2%', up:false, icon:'assets/logos/pengu.png' },
