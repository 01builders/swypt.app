// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$78,247', change:'+0.5%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,191', change:'+0.8%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$86.44', change:'+0.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$652.98', change:'+0.1%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'SUI', price:'$1.07', change:'+1.8%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.33', change:'+0.5%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.95', change:'+1.0%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.356', change:'+1.5%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.12', change:'+0.6%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000582', change:'-0.7%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.57', change:'+2.3%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.54', change:'+4.1%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000375', change:'+0.5%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.06', change:'+4.2%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$394.07', change:'+3.5%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$514.50', change:'+3.7%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00857', change:'+1.5%', up:true, icon:'assets/logos/pengu.png' },
