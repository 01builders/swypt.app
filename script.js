// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,454', change:'+0.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,107', change:'+0.2%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$84.18', change:'+0.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$638.66', change:'+0.3%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'SUI', price:'$1.06', change:'+2.8%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.07', change:'+0.0%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.97', change:'+2.1%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.354', change:'-0.1%', up:false, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.115', change:'+0.2%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000570', change:'+1.1%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.62', change:'+7.8%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000365', change:'+0.7%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.02', change:'+1.0%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$391.12', change:'+1.5%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$557.93', change:'+6.4%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00850', change:'+3.5%', up:true, icon:'assets/logos/pengu.png' },
