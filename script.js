// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$80,741', change:'+1.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,260', change:'-0.2%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$91.16', change:'+0.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$684.12', change:'+2.3%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.47', change:'+2.7%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.268', change:'+1.1%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.114', change:'+0.2%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$10.33', change:'+1.0%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.15', change:'-3.3%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.76', change:'+0.5%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$2.07', change:'-1.7%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.34', change:'+0.9%', up:true, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.353', change:'+0.8%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.128', change:'-1.3%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000628', change:'-0.0%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.69', change:'+2.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.57', change:'-0.0%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000403', change:'-0.2%', up:false, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$395.31', change:'+0.1%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$545.78', change:'+3.8%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.218', change:'-1.4%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00903', change:'+0.5%', up:true, icon:'assets/logos/pengu.png' },
