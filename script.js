// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$63,629', change:'-1.6%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,883', change:'-1.8%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$73.63', change:'-0.6%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$592.52', change:'+1.2%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.07', change:'-0.8%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.171', change:'+3.1%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0695', change:'-0.5%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.26', change:'-1.9%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$6.47', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.39', change:'-1.5%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.761', change:'-0.5%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0766', change:'-1.6%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000470', change:'+1.8%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$4.38', change:'+4.1%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.67', change:'+1.4%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000277', change:'+0.7%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.24', change:'-3.5%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$349.87', change:'-2.6%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$460.69', change:'-2.6%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.195', change:'-0.9%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00609', change:'+4.8%', up:true, icon:'assets/logos/pengu.png' },
