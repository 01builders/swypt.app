// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$77,548', change:'+1.0%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,138', change:'+1.2%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$86.08', change:'+2.0%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$649.91', change:'+1.6%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.37', change:'+0.9%', up:true, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.104', change:'+0.9%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.65', change:'+2.0%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.07', change:'+1.6%', up:true, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$2.05', change:'+1.5%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.112', change:'-2.1%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000579', change:'+1.9%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.62', change:'+4.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.68', change:'+2.5%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000373', change:'+2.4%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.01', change:'-2.1%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$399.19', change:'+2.4%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$685.35', change:'+19.7%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.21', change:'+7.6%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00911', change:'+6.1%', up:true, icon:'assets/logos/pengu.png' },
