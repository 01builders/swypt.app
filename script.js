// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$77,625', change:'+0.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,133', change:'+0.4%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$87.32', change:'+1.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$657.17', change:'+1.4%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.77', change:'+1.7%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.13', change:'+5.1%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.47', change:'+2.4%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$2.05', change:'+0.9%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.30', change:'+4.2%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'SHIB', price:'$0.00000584', change:'+1.3%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.96', change:'+15.2%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000381', change:'+2.8%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.05', change:'+3.7%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$397.99', change:'-1.5%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$667.89', change:'-0.5%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.214', change:'+0.4%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00955', change:'+5.6%', up:true, icon:'assets/logos/pengu.png' },
