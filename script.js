// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$79,407', change:'-1.4%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,256', change:'-1.3%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$90.88', change:'-4.0%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$669.58', change:'+0.4%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.113', change:'+2.4%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$10.15', change:'-1.4%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.20', change:'-3.0%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.72', change:'-1.4%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$2.11', change:'-8.8%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.33', change:'-1.0%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.132', change:'-4.1%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000627', change:'-2.6%', up:false, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$1.57', change:'-3.3%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000404', change:'-2.8%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.04', change:'-3.0%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$391.17', change:'-5.0%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$518.44', change:'-6.7%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.222', change:'-4.3%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00897', change:'-6.2%', up:false, icon:'assets/logos/pengu.png' },
