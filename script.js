// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$63,387', change:'-0.1%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,886', change:'+0.3%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$76.14', change:'+0.8%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$610.77', change:'+0.1%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.01', change:'+0.1%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.182', change:'+0.2%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0701', change:'+0.7%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.86', change:'+2.2%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.687', change:'+0.7%', up:true, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'DOT', price:'$0.774', change:'-0.3%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0752', change:'-0.9%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000445', change:'+1.1%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.49', change:'-1.3%', up:false, icon:'assets/logos/uni.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.51', change:'+8.1%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$396.28', change:'+1.6%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$486.33', change:'-0.8%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.17', change:'+0.2%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00622', change:'-1.0%', up:false, icon:'assets/logos/pengu.png' },
