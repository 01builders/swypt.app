// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$78,186', change:'+0.6%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,303', change:'-0.0%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.83', change:'-0.5%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$615.85', change:'-0.6%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.39', change:'+0.2%', up:true, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.107', change:'-1.4%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.08', change:'-1.1%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$9.09', change:'-0.7%', up:false, icon:'assets/logos/avax.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.122', change:'-2.9%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000625', change:'-1.4%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.22', change:'-0.2%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.28', change:'-1.8%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000392', change:'-1.1%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.88', change:'-1.1%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$384.63', change:'+0.8%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$373.68', change:'+6.6%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.178', change:'-1.7%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.01', change:'+0.2%', up:true, icon:'assets/logos/pengu.png' },
