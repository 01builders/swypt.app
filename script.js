// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$63,054', change:'+0.1%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,882', change:'+0.0%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$75.43', change:'+0.1%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$607.04', change:'-0.5%', up:false, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.34', change:'-1.0%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.35', change:'+0.4%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'UNI', price:'$3.31', change:'+2.1%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.62', change:'-0.9%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000261', change:'-1.0%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.48', change:'+1.0%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$415.57', change:'+2.4%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$492.85', change:'+0.7%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.168', change:'-0.4%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00606', change:'+0.6%', up:true, icon:'assets/logos/pengu.png' },
