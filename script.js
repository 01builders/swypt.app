// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$78,115', change:'-1.4%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,176', change:'-2.3%', up:false, icon:'assets/logos/eth.svg' },
  ...
  { type:'price', symbol:'BNB', price:'$655.70', change:'-2.7%', up:false, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.109', change:'-3.2%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.74', change:'-3.5%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.06', change:'-3.6%', up:false, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.93', change:'-3.4%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.28', change:'-3.5%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.12', change:'-4.4%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000587', change:'-4.4%', up:false, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'PEPE', price:'$0.00000377', change:'-4.0%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.00', change:'+2.7%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$385.00', change:'+0.6%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$512.61', change:'-2.1%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.2', change:'-5.6%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00847', change:'-4.5%', up:false, icon:'assets/logos/pengu.png' },
