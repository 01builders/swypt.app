// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$71,453', change:'+2.9%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,216', change:'+4.7%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.28', change:'+1.4%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$604.53', change:'-0.7%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.35', change:'+2.5%', up:true, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.0932', change:'+0.9%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.99', change:'+2.8%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.921', change:'+3.1%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.18', change:'+4.5%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.25', change:'+2.3%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'SHIB', price:'$0.00000598', change:'+0.3%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.16', change:'+1.6%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.35', change:'+6.6%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000354', change:'+1.4%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.78', change:'+3.9%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$322.35', change:'-1.9%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$324.91', change:'+17.1%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.162', change:'+1.1%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00659', change:'+1.9%', up:true, icon:'assets/logos/pengu.png' },
