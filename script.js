// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$80,976', change:'+0.1%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,331', change:'+0.3%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$95.05', change:'+1.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$653.94', change:'+0.5%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.45', change:'+1.8%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.279', change:'+2.5%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.11', change:'+1.3%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$10.57', change:'+0.7%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.27', change:'+10.7%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$10.11', change:'+1.2%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$2.32', change:'-4.4%', up:false, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'TRX', price:'$0.351', change:'+0.6%', up:true, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.142', change:'-1.0%', up:false, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'UNI', price:'$3.92', change:'+0.7%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.56', change:'-0.6%', up:false, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$2.06', change:'+6.4%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$410.71', change:'+1.0%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$569.45', change:'-4.9%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.255', change:'+1.7%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.0103', change:'-1.8%', up:false, icon:'assets/logos/pengu.png' },
