// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$60,319', change:'+1.2%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,616', change:'+3.0%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$75.47', change:'+6.7%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$559.73', change:'+1.7%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.06', change:'+1.9%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.147', change:'+2.8%', up:true, icon:'assets/logos/ada.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$7.44', change:'+3.2%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.705', change:'+3.8%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$6.69', change:'+5.1%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.61', change:'+2.6%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.827', change:'+2.7%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0769', change:'+5.4%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000429', change:'+3.4%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$2.93', change:'+1.4%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.87', change:'+2.5%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$313.69', change:'+0.9%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$407.40', change:'+7.7%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00626', change:'+3.2%', up:true, icon:'assets/logos/pengu.png' },
