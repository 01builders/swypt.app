// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,971', change:'+0.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,118', change:'+0.3%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$84.72', change:'+0.7%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$640.13', change:'+0.3%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$9.60', change:'+2.0%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$1.06', change:'+3.2%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.14', change:'+0.9%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.99', change:'+3.3%', up:true, icon:'assets/logos/ton.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.116', change:'+1.0%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000573', change:'+1.6%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.49', change:'+3.1%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.61', change:'+6.8%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000366', change:'+1.4%', up:true, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$2.07', change:'+3.0%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$390.99', change:'+1.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$557.73', change:'+7.3%', up:true, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.00857', change:'+5.1%', up:true, icon:'assets/logos/pengu.png' },
