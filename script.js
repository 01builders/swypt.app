// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,706', change:'+3.3%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,875', change:'+5.1%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$77.97', change:'+3.9%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$579.44', change:'+1.6%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.10', change:'+3.3%', up:true, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.074', change:'+2.8%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.32', change:'+4.9%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.753', change:'+3.6%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$6.65', change:'+3.2%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.61', change:'+1.4%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.851', change:'+1.8%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0897', change:'+0.4%', up:true, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$2.02', change:'+2.7%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000278', change:'+1.4%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$331.19', change:'+2.9%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$552.45', change:'+9.2%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.214', change:'+4.7%', up:true, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00606', change:'+4.7%', up:true, icon:'assets/logos/pengu.png' },
