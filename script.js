// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,407', change:'+0.4%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,870', change:'+1.4%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$76.10', change:'+1.7%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$567.63', change:'-0.5%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.09', change:'+0.4%', up:true, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.165', change:'+0.4%', up:true, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0724', change:'+0.1%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.33', change:'+0.5%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.751', change:'+2.1%', up:true, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.43', change:'-3.6%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.825', change:'-1.1%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0885', change:'-1.4%', up:false, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'UNI', price:'$3.52', change:'+0.4%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.92', change:'+0.3%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000284', change:'+4.0%', up:true, icon:'assets/logos/pepe.svg' },
  ...
  { type:'price', symbol:'XMR', price:'$334.52', change:'+1.3%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$554.55', change:'+1.5%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.192', change:'-0.9%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00608', change:'+1.3%', up:true, icon:'assets/logos/pengu.png' },
