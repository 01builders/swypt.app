// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$76,536', change:'+1.0%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$2,299', change:'+1.4%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$83.86', change:'+0.8%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$621.51', change:'+0.2%', up:true, icon:'assets/logos/bnb.svg' },
  ...
  { type:'price', symbol:'DOGE', price:'$0.105', change:'+6.9%', up:true, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$9.21', change:'+0.4%', up:true, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.918', change:'+0.2%', up:true, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$9.21', change:'+0.7%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.32', change:'+2.1%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$1.23', change:'+0.2%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.127', change:'+2.8%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000620', change:'+1.9%', up:true, icon:'assets/logos/shib.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.95', change:'+0.4%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$383.83', change:'+0.9%', up:true, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$326.59', change:'-2.2%', up:false, icon:'assets/logos/zec.svg' },
  ...
  { type:'price', symbol:'PENGU', price:'$0.01000', change:'-2.1%', up:false, icon:'assets/logos/pengu.png' },
