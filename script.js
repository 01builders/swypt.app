// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,128', change:'+0.7%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,873', change:'+0.6%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$73.96', change:'+0.5%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$593.74', change:'+0.3%', up:true, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.08', change:'-0.5%', up:false, icon:'assets/logos/xrp.svg' },
  ...
  { type:'price', symbol:'LINK', price:'$8.20', change:'-0.6%', up:false, icon:'assets/logos/link.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$6.74', change:'+3.5%', up:true, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.39', change:'-1.2%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.834', change:'+1.4%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0818', change:'+0.8%', up:true, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000502', change:'+2.2%', up:true, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$3.83', change:'-2.7%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.73', change:'-0.8%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000290', change:'-0.3%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.37', change:'+2.2%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$360.20', change:'-0.2%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$493.10', change:'+0.9%', up:true, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.189', change:'-1.3%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00608', change:'-1.5%', up:false, icon:'assets/logos/pengu.png' },
