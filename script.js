// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$60,217', change:'-0.0%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,581', change:'+0.0%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$71.93', change:'+0.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$555.73', change:'-1.3%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.05', change:'-0.5%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.145', change:'-1.2%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0737', change:'-2.1%', up:false, icon:'assets/logos/doge.svg' },
  ...
  { type:'price', symbol:'AVAX', price:'$6.32', change:'-3.0%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.56', change:'-0.5%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.811', change:'-3.4%', up:false, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0743', change:'-0.7%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000420', change:'-1.2%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$2.93', change:'+0.5%', up:true, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$1.86', change:'+2.6%', up:true, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000240', change:'-0.3%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.58', change:'-1.8%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$311.66', change:'-0.7%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$385.45', change:'-5.3%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.217', change:'-2.1%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00625', change:'+0.5%', up:true, icon:'assets/logos/pengu.png' },
