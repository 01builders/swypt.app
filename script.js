// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$64,129', change:'+0.8%', up:true, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,803', change:'+0.8%', up:true, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$82.24', change:'+0.3%', up:true, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$586.08', change:'-0.8%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.15', change:'-0.6%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.184', change:'-2.9%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0767', change:'-1.3%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$8.02', change:'-0.5%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.751', change:'-0.5%', up:false, icon:'assets/logos/sui.svg' },
  ...
  { type:'price', symbol:'TON', price:'$1.79', change:'+0.6%', up:true, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.884', change:'+0.4%', up:true, icon:'assets/logos/dot.svg' },
  ...
  { type:'price', symbol:'ARB', price:'$0.0803', change:'+0.1%', up:true, icon:'assets/logos/arb.svg' },
  ...
  { type:'price', symbol:'NEAR', price:'$2.07', change:'+3.0%', up:true, icon:'assets/logos/near.svg' },
  ...
  { type:'price', symbol:'ATOM', price:'$1.60', change:'+0.9%', up:true, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$322.70', change:'-0.9%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$454.14', change:'-2.1%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.239', change:'-2.3%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00676', change:'-0.3%', up:false, icon:'assets/logos/pengu.png' },
