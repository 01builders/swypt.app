// ─── TICKER DATA ───
var TICKER_DATA = [
  { type:'price', symbol:'BTC', price:'$62,632', change:'-4.3%', up:false, icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'ETH', price:'$1,683', change:'-4.8%', up:false, icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'SOL', price:'$68.62', change:'-6.9%', up:false, icon:'assets/logos/sol.svg' },
  { type:'predict', question:'BTC > $150K by EOY?', odds:'72% YES', icon:'assets/logos/btc.svg' },
  { type:'price', symbol:'BNB', price:'$575.58', change:'-5.2%', up:false, icon:'assets/logos/bnb.svg' },
  { type:'price', symbol:'XRP', price:'$1.14', change:'-5.8%', up:false, icon:'assets/logos/xrp.svg' },
  { type:'price', symbol:'ADA', price:'$0.162', change:'-4.7%', up:false, icon:'assets/logos/ada.svg' },
  { type:'predict', question:'Trump wins 2028?', odds:'52% YES', emoji:'\uD83C\uDDFA\uD83C\uDDF8' },
  { type:'price', symbol:'DOGE', price:'$0.0824', change:'-5.4%', up:false, icon:'assets/logos/doge.svg' },
  { type:'price', symbol:'LINK', price:'$7.85', change:'-5.0%', up:false, icon:'assets/logos/link.svg' },
  { type:'price', symbol:'SUI', price:'$0.718', change:'-10.0%', up:false, icon:'assets/logos/sui.svg' },
  { type:'predict', question:'Fed cuts rates June?', odds:'61% YES', emoji:'\uD83C\uDFE6' },
  { type:'price', symbol:'AVAX', price:'$6.30', change:'-8.8%', up:false, icon:'assets/logos/avax.svg' },
  { type:'price', symbol:'TON', price:'$1.65', change:'-0.8%', up:false, icon:'assets/logos/ton.svg' },
  { type:'price', symbol:'DOT', price:'$0.958', change:'-7.3%', up:false, icon:'assets/logos/dot.svg' },
  { type:'predict', question:'SOL flips ETH?', odds:'34% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'TRX', price:'$0.319', change:'-0.5%', up:false, icon:'assets/logos/trx.svg' },
  { type:'price', symbol:'ARB', price:'$0.0825', change:'-5.7%', up:false, icon:'assets/logos/arb.svg' },
  { type:'price', symbol:'SHIB', price:'$0.00000468', change:'-6.8%', up:false, icon:'assets/logos/shib.svg' },
  { type:'predict', question:'Champions League winner?', odds:'38% Real Madrid', emoji:'\u26BD' },
  { type:'price', symbol:'UNI', price:'$2.97', change:'-9.6%', up:false, icon:'assets/logos/uni.svg' },
  { type:'price', symbol:'NEAR', price:'$2.18', change:'-6.2%', up:false, icon:'assets/logos/near.svg' },
  { type:'price', symbol:'PEPE', price:'$0.00000281', change:'-6.2%', up:false, icon:'assets/logos/pepe.svg' },
  { type:'predict', question:'Spot SOL ETF this year?', odds:'67% YES', icon:'assets/logos/sol.svg' },
  { type:'price', symbol:'ATOM', price:'$1.78', change:'-9.3%', up:false, icon:'assets/logos/atom.svg' },
  { type:'price', symbol:'XMR', price:'$321.14', change:'-4.8%', up:false, icon:'assets/logos/xmr.svg' },
  { type:'price', symbol:'ZEC', price:'$444.86', change:'-10.8%', up:false, icon:'assets/logos/zec.svg' },
  { type:'predict', question:'ETH > $10K?', odds:'48% YES', icon:'assets/logos/eth.svg' },
  { type:'price', symbol:'JUP', price:'$0.186', change:'-4.1%', up:false, icon:'assets/logos/jup.svg' },
  { type:'price', symbol:'PENGU', price:'$0.00655', change:'-9.0%', up:false, icon:'assets/logos/pengu.png' },
